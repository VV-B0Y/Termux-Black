...
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection {
    ...
    private void setSettingsButtonView() {
        ...
        // Opens the VM control screen: start/stop the guest, open its console, attach the adapter.
        View vmButton = findViewById(R.id.rootless_vm_button);
        if (vmButton != null) {
            vmButton.setOnClickListener(v -> ActivityUtils.startActivity(this,
                new Intent(this, com.termux.app.rootless.RootlessActivity.class)));
        }
    }
    ...
    /**
     * Launcher-style gesture: swiping left-to-right anywhere on screen pulls the sessions drawer
     * out fullscreen, the way a modern launcher reveals its feed.
     *
            ...
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if (mDrawerSwipeTracking) {
                        ...
                        // Clearly rightward and clearly horizontal, so vertical scrolling in the
                        // terminal is never mistaken for the gesture.
                        if (dx > slop && Math.abs(dx) > Math.abs(dy) * 2) {
