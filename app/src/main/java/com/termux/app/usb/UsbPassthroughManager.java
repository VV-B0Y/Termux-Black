...
public final class UsbPassthroughManager {
    ...
    private static final String ACTION_USB_PERMISSION = "com.termux.app.USB_PERMISSION";
    ...
    public synchronized boolean attach(UsbDevice device) {
        ...
        if (!qmp.isConnected() && !qmp.connect()) {
            Log.w(TAG, "QMP socket not connected or VM not running");
            return false;
        }
        ...
        String qemuId = "termux_usb_" + device.getDeviceId();
        try {
